...
public class Javapad extends JFrame implements ActionListener,WindowListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (e.getSource() == feat)
		{
			String msg = "WELCOME TO Javapad powered by SciFiSoft" + "\n" + "\n" + "'Javapad' provided by 'WINDOWS'" + "\n" + "\n" + "Website : www.scifisoft.com";
		...
		{
			JOptionPane.showMessageDialog(null,"JavaPad is developed by SciFiSoft" + "\n" + "Email us at -fidelityscience@gmail.com");
		}
		
		if (e.getSource() == exit)
		{
			System.out.println("Thank You For Using Javapad");
			System.exit(0);
		}
